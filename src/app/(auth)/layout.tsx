  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <header className="absolute top-0 w-full p-6">
        <Link
          href="/"
          className="flex items-center gap-2 text-primary font-heading font-bold text-xl hover:text-primary-400 transition-colors"
        >
      ...
      <main className="flex-1 flex items-center justify-center p-6 sm:p-12 relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10 glass p-8 sm:p-12 rounded-xl">{children}</div>
      </main>
    </div>
  );
}
