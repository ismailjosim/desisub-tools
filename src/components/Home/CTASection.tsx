  ...
  return (
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        <div className="rounded-3xl border border-primary/20 bg-linear-to-b from-primary/10 to-violet-900/10 p-14 backdrop-blur-sm ring-1 ring-foreground/5">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              ...
              className="rounded-xl border border-border bg-foreground/5 px-8 py-4 text-base font-medium text-foreground/75 backdrop-blur-sm transition-all duration-200 hover:border-foreground/20 hover:bg-foreground/10 hover:text-foreground"
            >
              Sign in instead
            </Link>
          </div>
